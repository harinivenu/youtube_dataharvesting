...
api_key = "AIzaSyDtykpPgJNi6ejtTi3A2ECVDI-Xbhar4HQ"
you_tube = build("youtube", "v3", developerKey=api_key)


client = pymongo.MongoClient("mongodb+srv://dineesh:Ckd12345@cluster0.xjertx7.mongodb.net/?retryWrites=true&w=majority")
...
conn = psycopg2.connect(host="localhost", user="postgres", password= "Ckd1234.", port = 5432, database = "guvi")
cur = conn.cursor()
